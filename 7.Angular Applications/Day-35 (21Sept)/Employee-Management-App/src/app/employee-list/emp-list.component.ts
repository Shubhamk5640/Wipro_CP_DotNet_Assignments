...
export class EmployeeListComponent {
  employees: Employee[] = [
    { id: 1, name: 'John Doe', age: 30, salary: 100000, position: 'Software Engineer', department: 'IT' },
    { id: 2, name: 'Jane Smith', age: 33, salary: 20000, position: 'Product Manager', department: 'Sales' },
    { id: 3, name: 'Bob Johnson', age: 25, salary: 40000, position: 'Designer', department: 'Marketing' }
  ];
